# -*- coding: utf-8 -*-
"""HumanActivityRecognitionLRCN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sA1Y6kcURiJGi3-dDwHxPGB_ka1L0IUs
"""
...
def build_LRCN_model():
  model = Sequential()

  model.add(TimeDistributed(Conv2D(filters = 16, kernel_size=(3,3), padding='same', activation='relu'), input_shape = (input_data.shape[1:])))
  ...
  model.add(LSTM(32))
  model.add(Dense(len(Classes_lıst),'softmax'))
...
plot_model(model, to_file='LRCN.png', show_shapes=True, show_layer_names=True)
...
current_datetime_string = dt.datetime.strftime(current_date_time,date_time_format)

model_file_name = f'LRCN_Model_{current_date_time}_accuracy_{model_evaluation_accuracy}.h5'
